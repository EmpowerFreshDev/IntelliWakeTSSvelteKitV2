...
<div class='grid grid-rows-[auto_1fr] overflow-hidden'>
	<div class='grid mx-auto mb-2'
		...
		{#each visibleItems as item}
			<button class='btnClean bg-transparent border-transparent border-b-4 text-black shadow-none drop-shadow-none rounded-none focus:ring-0 m-2 min-w-[3em] text-ellipsis whitespace-nowrap overflow-hidden hover:bg-transparent hover:border-b-primary-main'
