...
<script>export let pointerPosition = "Top";
...
$: style = (() => {
  function createStyles(pointer, isAfter) {
    const styles2 = [];
    const prefix = `--pointer${isAfter ? "-after" : "-before"}-`;
    styles2.push(`${prefix}left-adjust: ${pointer.leftAdjust}`);
    styles2.push(`${prefix}right-adjust: ${pointer.rightAdjust}`);
    styles2.push(`${prefix}bottom-adjust: ${pointer.bottomAdjust}`);
    styles2.push(`${prefix}top-adjust: ${pointer.topAdjust}`);
    styles2.push(`${prefix}rotate: ${pointer.rotate}`);
    styles2.push(`${prefix}translate-x: ${pointer.translateX}`);
    styles2.push(`${prefix}translate-y: ${pointer.translateY}`);
    styles2.push(`${prefix}left-border-width: ${pointer.leftBorderWidth}`);
    styles2.push(`${prefix}right-border-width: ${pointer.rightBorderWidth}`);
    styles2.push(`${prefix}top-border-width: ${pointer.topBorderWidth}`);
    styles2.push(`${prefix}bottom-border-width: ${pointer.bottomBorderWidth}`);
    styles2.push(`${prefix}left-border-color: ${pointer.leftBorderColor}`);
    styles2.push(`${prefix}right-border-color: ${pointer.rightBorderColor}`);
    styles2.push(`${prefix}top-border-color: ${pointer.topBorderColor}`);
    styles2.push(`${prefix}bottom-border-color: ${pointer.bottomBorderColor}`);
    return styles2;
  }
  const beforePointer = {
    leftAdjust: "auto",
