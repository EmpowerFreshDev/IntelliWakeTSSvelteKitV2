 ...
 */
export declare const DisplayColorStyle: (hue: number | null | undefined, saturation: number | null | undefined, lightness: number | null | undefined, options?: TDisplayColorStyleOptions) => string | undefined;
