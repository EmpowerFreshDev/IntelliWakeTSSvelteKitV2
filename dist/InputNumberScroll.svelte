...
export let maxManualEntryDigits = null;
...
function setValue(numb, doNotNull) {
  if (!readonly) {
...
$: valueHighlightExistsInQuickArray = valueHighlight !== void 0 && quickArray.some((qa) => qa == CleanNumberNull(valueHighlight, GreaterNumber(maxDigitsDisplay, 2)));
</script>
